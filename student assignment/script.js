...
function filterJS() {
    ...
    const getCourse = document.getElementById('get-course').value.trim();

    currentView = "js";
    const studentJS = students.filter(student => student.course.toLowerCase().trim() === `${getCourse}`.toLowerCase());
